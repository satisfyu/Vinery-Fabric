...
public class ModBoatEntity extends Boat {
    ...
    public ModBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(EntityTypeRegistry.MOD_BOAT.get(), pLevel);
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case DARK_CHERRY -> {
                return ObjectRegistry.DARK_CHERRY_BOAT.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.DARK_CHERRY.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        ...
        DARK_CHERRY(ObjectRegistry.DARK_CHERRY_PLANKS.get(), "dark_cherry");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, DARK_CHERRY);
        }
    }
}
