...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public ModChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(EntityTypeRegistry.MOD_CHEST_BOAT.get(), pLevel);
    ...
    public Item getDropItem() {
        ...
        switch (getModVariant()) {
            case DARK_CHERRY -> {
                return ObjectRegistry.DARK_CHERRY_CHEST_BOAT.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.DARK_CHERRY.ordinal());
    }
