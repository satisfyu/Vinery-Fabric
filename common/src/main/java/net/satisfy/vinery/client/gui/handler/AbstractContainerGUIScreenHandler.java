...
public abstract class AbstractContainerGUIScreenHandler extends AbstractGUIScreenHandler {
    protected final Container inventory;
    protected final ContainerData propertyDelegate;
    protected final Level world;
    private final int inputSlots;
    protected AbstractContainerGUIScreenHandler(MenuType<?> screenHandler, int syncId, int inputSlots, Inventory playerInventory, Container inventory, ContainerData propertyDelegate) {
